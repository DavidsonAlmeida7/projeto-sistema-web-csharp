...
using ProjetoSistemaWeb.Models.Enums;

namespace ProjetoSistemaWeb.Data
{
    public class SeedingService
    {
        private ProjetoSistemaWebContext _context;

        public SeedingService(ProjetoSistemaWebContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 5300.0, d3);
            Seller s6 = new Seller(6, "Davidson Almeida", "davidson@gmail.com", new DateTime(1992, 5, 29), 3000.0, d2);
